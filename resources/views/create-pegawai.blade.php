...
@section('container')
    ...
    @if (Session::has('status_gagalcreate_pegawai'))
        <script>
            $(document).ready(function() {
                Swal.fire({
                    icon: "error",
                    title: "Error",
                    text: "{{ Session::get('status_gagalcreate_pegawai') }}",
                });
            })
        </script>
    @endif
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ url('/store-pegawai') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <label id="nip" class="col-sm-2 col-form-label">NIP Lama</label>
                                <div class="col-sm-10">
                                    <input name="nip" class="form-control @error('nip') is-invalid @enderror"
                                        value="{{ old('nip') }}" placeholder="9 digit" />
                                    @error('nip')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select name="jabatan"class="@error('jabatan') is-invalid @enderror">
                                        <option value="" disable selected>Pilih Jabatan</option>
