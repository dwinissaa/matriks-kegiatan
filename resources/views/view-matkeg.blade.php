...
@section('container')
                        ...
                        <div class="container">
                            ...
                            <div class="tab-content mt-4" id="myTabContent">
                                <div class="tab-pane fade show active" id="matkeg_pegawai" role="tabpanel"
                                    ...
                                    <h5 class="card-title">Matriks Kegiatan Pegawai</h5>
                                ...
                                <div class="tab-pane fade" id="matkeg_mitra" role="tabpanel"
                                    ...
                                    <h5 class="card-title">Matriks Kegiatan Mitra</h5>
                                    <!-- Table with stripped rows -->
    ...
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                url: 'getUser/role=pegawai/tahun=' + $('select[name="tahun"]').val() + '/bulan=' + f_bulan,
                type: "GET",
                data: {
                    '_token': '{{ csrf_token() }}'
                },
                ...
                success: function(data) {
                    ...
                    $('<th>Total Kegiatan</th>').appendTo('#matkeg-table-peg' + ">thead>tr");
                    kolom_js.push({
            ...
            $('.filter').on('change', function() {
                ...
                $.ajax({
                    url: 'getUser/role=pegawai/tahun=' + $('select[name="tahun"]').val() +
                        '/bulan=' + f_bulan,
                    type: "GET",
                    data: {
                        '_token': '{{ csrf_token() }}'
                    ...
                    success: function(data) {
                        ...
                        $('<th>Total Kegiatan</th>').appendTo('#matkeg-table-peg' +
                            ">thead>tr");
                        kolom_js.push({
                            "data": "total_pekerjaan",
                            "name": "total_pekerjaan"
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('<th>Total Kegiatan</th>').appendTo('#matkeg-table-mit' + ">thead>tr");
                    kolom_mit.push({
                        "data": "total_pekerjaan",
                        "name": "total_pekerjaan"
                    });
            ...
            $('.filter_').on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('<th>Total Kegiatan</th>').appendTo('#matkeg-table-mit' +
                            ">thead>tr");
                        kolom_mit.push({
                            "data": "total_pekerjaan",
                            "name": "total_pekerjaan"
