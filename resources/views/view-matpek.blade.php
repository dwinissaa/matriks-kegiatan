...
@section('container')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            document.querySelector('#matriks-pekerjaan').classList.add('active');
    ...
    <div class="pagetitle">
        <h1>Matriks Pekerjaan</h1>
        <span id="puthere"></span>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
                <li class="breadcrumb-item active">Matriks Pekerjaan</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
                        ...
                        <div class="container">
                            ...
                            <div class="tab-content mt-4" id="myTabContent">
                                <div class="tab-pane fade show active" id="matkeg_pegawai" role="tabpanel"
                                    ...
                                    <h5 class="card-title">Matriks Pekerjaan Pegawai</h5>
                                ...
                                <div class="tab-pane fade" id="matkeg_mitra" role="tabpanel"
                                    ...
                                    <h5 class="card-title">Matriks Pekerjaan Mitra</h5>
                                    <!-- Table with stripped rows -->
    ...
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                url: 'getUserPek/role=pegawai/tahun=' + $('select[name="tahun"]').val() + '/bulan=' + f_bulan,
                type: "GET",
                data: {
                    '_token': '{{ csrf_token() }}'
                },
                ...
                success: function(data) {
                    ...
                    $('<th>Total Pekerjaan</th>').appendTo('#matkeg-table-peg' + ">thead>tr");
                    kolom_js.push({
            ...
            $('.filter').on('change', function() {
                ...
                $.ajax({
                    url: 'getUserPek/role=pegawai/tahun=' + $('select[name="tahun"]').val() +
                        '/bulan=' + f_bulan,
                    type: "GET",
                    data: {
                        '_token': '{{ csrf_token() }}'
                    ...
                    success: function(data) {
                        ...
                        $('<th>Total Pekerjaan</th>').appendTo('#matkeg-table-peg' +
                            ">thead>tr");
                        kolom_js.push({
                            "data": "total_pekerjaan",
                            "name": "total_pekerjaan"
            ...
            $.ajax({
                url: 'getUser/role=mitra/tahun=' + $('select[name="tahun_"]').val() + '/bulan=' + f_bulan_,
                type: "GET",
                data: {
                    '_token': '{{ csrf_token() }}'
                },
            ...
            $('.filter_').on('change', function() {
                ...
                $.ajax({
                    url: 'getUser/role=mitra/tahun=' + $('select[name="tahun_"]').val() +
                        '/bulan=' + f_bulan_,
                    type: "GET",
                    data: {
                        '_token': '{{ csrf_token() }}'
